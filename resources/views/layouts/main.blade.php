...
<head class="no-js" lang="en">
    ...
    <!-- Critical styles ================================================== -->
    <link rel="stylesheet" href="{{asset('asset/css/critical.min.css')}}" type="text/css">
...
<body>
    <div id="app">
        ...
        <header id="top-bar" class="top-bar top-bar--style-3">
            <div class="top-bar__bg" style="background-image: url(asset/images/home_img/home_bg.jpg);background-size: cover;background-repeat: no-repeat;background-position: 40% bottom;"></div>

            <div class="container position-relative">
                <div class="row align-items-center no-gutters">

                    <a class="top-bar__logo site-logo" href="index.html">
                        <img class="img-fluid" src="{{asset('asset/images/site_logo.png')}}" alt="demo" />
                    </a>
        ...
        <main role="main">
            <!-- Common styles
            ================================================== -->
            <link rel="stylesheet" href="{{asset('asset/css/style.min.css')}}" type="text/css">
                            ...
                            <div class="col-12 col-sm-4 col-md-4 col-lg-3">
                                <div class="footer__item">
                                    <a class="site-logo" href="index.html">
                                        <img class="img-fluid  lazy" src="{{asset('asset/images/blank.gif')}}" data-src="{{asset('asset/images/site_logo.png')}}" alt="demo" />
                                    </a>
                                </div>
                            </div>
    ...
    <script>window.jQuery || document.write('<script src="{{asset("asset/js/jquery-2.2.4.min.js")}}"><\/script>')</script>
